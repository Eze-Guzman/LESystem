...
<body style="background-color: #ff9747;">

    <div class="jumbotron jumbotron-fluid" style="background-color: #ff9747;">
    <div class="container" >
        <h1 class="display-4">Ciencias Naturales</h1>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="../../agregarArchivo.php" enctype="multipart/form-data" method="POST" 
        id="frmAgregarMateria">
            <label for="">Archivo</label>
            <input type="file" id="archivos" name="archivos" class="form-control" multiple="" > 
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button class="btn btn-primary">Guardar Archivo</button>
            </div>
        </form>
      </div>
    </div>
...
<!-- Modal -->
<div class="modal fade" id="visualizarArchivo" tabindex="-1" aria-labelledby="exampleModalLabel" 
aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            $('#tablaMaterias').load("gestion_archivos.php");
