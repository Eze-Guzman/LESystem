        ...
        <section class="materias">
            ...
            <a href="admin/cuaderno/cuaderno.php" class="materias__link">
                <div class="materias__card">
                    ...
                    <h3 class="materias__title">NTICx</h3>
                    <p class="materias__text">
                        Profesor/a: Alejandro Bonifazi.
                    </p>
                </div>
            </a>
            ...
            <a href="admin/cuaderno/cuaderno.php" class="materias__link">
                <div class="materias__card">
                    <img src="../../assets/img materias/sado.png" alt="" class="materias__img">
                    <h3 class="materias__title">Salud y Adolescencia</h3>
                    <p class="materias__text">
            ...
            <a href="admin/cuaderno/cuaderno.php" class="materias__link">
                <div class="materias__card">
                    ...
                    <h3 class="materias__title">Introducción a la Física</h3>
                    <p class="materias__text">
                        Profesor/a: Julieta Rodríguez.
                    </p>
                </div>
            </a>
            ...
            <a href="admin/cuaderno/cuaderno.php" class="materias__link">
                <div class="materias__card">
                    ...
                    <h3 class="materias__title">Teoría de las Organizaciones</h3>
                    <p class="materias__text">
